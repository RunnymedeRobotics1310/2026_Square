 ...
 *
 * <p>Deadbanding of the axis values is is intended to prevent 'drift' or movement of the robot when
...
public class GameController extends XboxController {
   ...
   *
   * <p>Use the method {@link #getRawHardwareAxisValue(int)} to get the hardware value coming off
   * the game controller axis before deadbanding.
   *
